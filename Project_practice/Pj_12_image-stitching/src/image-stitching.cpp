/*
 * @Author: zhanghao
 * @Date: 2023-07-24 09:32:59
 * @LastEditTime: 2023-07-24 10:13:10
 * @FilePath: /hayden_opencv_tools/Project_practice/Pj_12_image-stitching/src/image-stitching.cpp
 * @Description: https://blog.csdn.net/Zero___Chen/article/details/122274445
 */
#include <iostream>
...
bool Image_Stitching(Mat image_left, Mat image_right, Mat &WarpImg, Mat &DstImg, bool draw)
{
    ...
    Ptr<xfeatures2d::SiftFeatureDetector> detector = xfeatures2d::SiftFeatureDetector::create(Hessian);
    ...
    */
    if (goodkeypoint_left.size() < 4 || goodkeypoint_right.size() < 4)
        return false;
...
int main()
{
    ...
    Mat image_left = imread("../Data/left.jpg");
    Mat image_right = imread("../Data/right.jpg");
