/*
 * @Author: zhanghao
 * @Date: 2023-06-10 17:02:49
 * @LastEditTime: 2023-06-10 17:16:55
 * @FilePath: /hayden_opencv_tools/orb_compare/src/orb_compare.cc
 * @Description: 
 */
#include <iostream>
...
int main (int argc, char** argv)
{
    ...
    cv::imwrite("save_slam_orb.jpg",slam_img);
    cv::imwrite("save_opencv_orb.jpg", opencv_img);
